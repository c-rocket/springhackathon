	...
	<div class="col-md-offset-1 col-md-4">
		...
		<div class="list-group">
			...
			<div class="form-group">
				...
				<a ng-repeat="item in items | filter:searchItem  | orderBy:'ITEM_POST_DATE':true"  
				ng-href="#/browse/{{item.ITEM_ID}}">
                ...
                <div>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="" data-toggle="modal" data-target="#ediModal">EDIT POST</a></li>
                            <li class="divider"></li>
                            <li><a href="">CANCEL POST</a></li>
                        </ul>
                    </div>
                </div>
								...
								<div class="row" ng-repeat="com in comments">
									...
									<div class="col-md-11">
										<div class="well well-sm cmt">
											...
											<span class="cmt-time pull-right"><span am-time-ago="com.COMMENT_CREATE_DATE"></span></span><br>

...
2 inch square with gilt floral design 1.75 inch diameter says FORCE and SAGESSE Salmon Size 34 SNS Profeil cross country ski boots Fit Karbu 130cm cross country skis
...
Insert into ITEMS (ITEM_ID,ITEM_TITLE,ITEM_DESC,ITEM_POST_DATE,ITEM_POSTED_BY,ITEM_BOUGHT_BY,ITEM_PRICE,ITEM_STATUS) values (9,'Garden Tool Organizer / Bicycle Storage Rack','Are you tired of tripping over a bunch of loose garden tools in your garage? Are your brooms, rakes, shovels, bicycles etc. always in a big cluttered mess? As a machine shop owner, I make a really nice, possibly the best, Garage Organizer - Garden Tool - Bicycle Storage Rack, where you can neatly hang these items.'
,to_date('09-JUL-15','DD-MON-RR'),7,null,89,'available');
...
price: $3600 firm email if interested and I will call you back asap. thx.Salmon Size 34 SNS Profeil cross country ski boots',to_date('09-JUL-15','DD-MON-RR'),8,null,3600,'sold');

Insert into ITEMS (ITEM_ID,ITEM_TITLE,ITEM_DESC,ITEM_POST_DATE,ITEM_POSTED_BY,ITEM_BOUGHT_BY,ITEM_PRICE,ITEM_STATUS) values (12,'VOX Standard 24 Guitar- Made in Japan',
'This is a Vox Standard 24 3503, made some time between 1979 and 82. 
...
The Dimarzio Super Distortion Humbuckers make this machine very powerful, crunchy and aggressive. Classic or Glam rock kind of way. 
Additional specs:
...
,to_date('09-JUL-15','DD-MON-RR'),10,null,500,'available');
...
2807 Encinal Ave.
Alameda
',to_date('09-JUL-15','DD-MON-RR'),9,null,150,'sold');
